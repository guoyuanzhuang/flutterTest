...
//import 'package:flutter_app/widget/pullzoom/gyz_pull_to_zoom_refresh.dart';
import 'package:pull_to_zoom_refresh/pull_to_zoom_refresh.dart';

void main() {
  runApp(ImageZoomPage());
}
...
class _ImageZoomPageState extends State<ImageZoomPage> with TickerProviderStateMixin{
