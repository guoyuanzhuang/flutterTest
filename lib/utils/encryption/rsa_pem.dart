...
//  String certFile = new File(localFile('raw/ddsc_debug.pem')).readAsStringSync();
//  print(certFile);
//  RSAPublicKey publicKey = RsaKeyHelper().parsePublicKeyFromPem(certFile.trim());
...
/*Uint8List decodePEM(String pemString) {
